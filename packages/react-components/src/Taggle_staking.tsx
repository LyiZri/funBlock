...
function ToggleStaking ({ className = '', isDisabled, isOverlay, isRadio, label, onChange, preventDefault, value }: Props): React.ReactElement<Props> {
...
export default React.memo(styled(ToggleStaking)`
  > label {
